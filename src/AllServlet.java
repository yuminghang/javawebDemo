...
//        }
    ...
    //爬虫方法
    private void craw(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String res = Craw.fetchURL("http://bbs.rs.xidian.me/forum.php?mod=guide&view=hot&mobile=2");
        List<ruisibean> list = Craw.praseData1(res);
